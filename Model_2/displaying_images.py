...
# Given filepaths to images and titles as strings, this function can display the images
...
# Given product indices and our pandas dataframe, this function can display the images from our dataset
...
# Given product ids and our pandas dataframe, this function can display the images from our dataset
...
# Given a product id, a path to the directory containing our product images, and a column from streamlit, 
# this function can display the corresponding image in streamlit
